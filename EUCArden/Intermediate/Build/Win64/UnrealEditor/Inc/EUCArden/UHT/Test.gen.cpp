...
#include "EUCArden/Test.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodeTest() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_AActor();
EUCARDEN_API UClass* Z_Construct_UClass_ATest();
EUCARDEN_API UClass* Z_Construct_UClass_ATest_NoRegister();
...
template<> EUCARDEN_API UClass* StaticClass<ATest>()
{
	return ATest::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_EUCArden_Source_EUCArden_Test_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATest, ATest::StaticClass, TEXT("ATest"), &Z_Registration_Info_UClass_ATest, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATest), 1646573061U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_EUCArden_Source_EUCArden_Test_h_1928115556(TEXT("/Script/EUCArden"),
	Z_CompiledInDeferFile_FID_EUCArden_Source_EUCArden_Test_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_EUCArden_Source_EUCArden_Test_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
